package com.saild.croplibrary.photo;
 ...
 */
public class Crop {
    public static String appPacket = "";
    ...
    public static void setAppPacket(String packet) {
        appPacket = packet;
    }
...
//            Log.e(TAG, e);
    ...
    private static Intent getTakePhoto(Context context) {
        ...
        outputFileUri = FileProvider.getUriForFile(context, appPacket + ".fileprovider", file);
